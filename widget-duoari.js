(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=duoari';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_eafebb9b18356c8b5c9ad6e47bd19123654d6b34";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/duoari-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/duoari-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/duoari-check-limit';
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        <img src="https://acdn-us.mitiendanube.com/stores/004/541/596/themes/common/logo-3824527950076872552-1782158977-632b8a91e87c775333b0b6af977f84a51782158977-640-0.webp" alt="DUOARI" style="height:52px;width:auto;"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=duoari" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=duoari" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
    ...
    function init() {
        ...
        const DUOARI_STORE_WHATSAPP = '5521981437438';
        function showLimitWhatsApp() {
            ...
            if (link) {
                ...
                link.href = 'https://wa.me/' + DUOARI_STORE_WHATSAPP + '?text=' + encodeURIComponent(msg);
            }
        }
        ...
        async function _checkProvasRestantes() {
            ...
            try {
                ...
                const _lim = Number(d.limit) || 3;   // limite vem do check-limit (fonte da verdade)
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'duoari', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    console.log('[PL Duoari] Enviando', allProdImgs.length, 'fotos do produto');
